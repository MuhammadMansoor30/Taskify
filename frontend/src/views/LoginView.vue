    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="height: 90vh;">
        ...
        <b-form @submit.prevent="submitForm()" class="w-50">
            <b-form-group id="email" label="Enter Your Email" label-for="email-input" label-class="text-left">
                <div>
                    <b-form-input id="email-input" type="email" v-model="email" required placeholder="test@email.com" :class="{'is-invalid': emailError}" />
                ...
                <div class="d-flex">
                    <b-input-group class="w-100">
                        <b-form-input id="password-input" :type="passwordVisible ? 'text' : 'password'"
                            v-model="password" required placeholder="*********"  :class="{'is-invalid': passwordError}"/>
