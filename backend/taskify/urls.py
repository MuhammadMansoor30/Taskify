...
urlpatterns = [
    ...
    path('users/<int:pk>/', view=views.UserUpdateDestroyView.as_view()),
    path('users/<int:pk>/update/', view=views.UserUpdateDestroyView.as_view()),
    path('users/<int:pk>/delete/', view=views.UserUpdateDestroyView.as_view()),
    ...
    path('managers/<int:pk>/', view=views.ManagerUpdateDestroyView.as_view()),
    ...
    path('teams/<int:pk>/', view=views.TeamUpdateDestroyView.as_view()),
    ...
    path('developers/<int:pk>/', view=views.DeveloperUpdateDestroyView.as_view()), 
    ...
    path('tasks/<int:pk>/', view=views.TaskUpdateDestroyView.as_view()),
    ...
    path('workItems/<int:pk>/', view=views.WorkItemUpdateDestroyView.as_view()),
